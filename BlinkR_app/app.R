...
saved_results <- reactiveValues(
  ...
  observe({
    ...
    measurements_module_server("measurements", i18n, db_student_table = db_student_table, db_measurement = db_measurement, auth = auth, parent.session = session, include_markdown_language = include_markdown_language, process_markdown = process_markdown)
    ...
    playground_module_server("playground", i18n, session_folder_id = session_folder_id, parent.session = session, include_markdown_language = include_markdown_language)
    analysis_dashboard_module_server("analysis_dashboard", i18n, parent.session = session, saved_results, session_folder_id = session_folder_id)
    ...
    analysis_create_figure_module_server("figure", i18n, results_data = combined_class_data_read_reactive, parent.session = session, saved_results = saved_results, session_folder_id = session_folder_id, process_markdown = process_markdown, include_markdown_language = include_markdown_language)
    writing_up_advice_server("writing_up_advice", i18n, parent.session = session, include_markdown_language)
    writing_up_ai_server("AI", i18n, parent.session = session, include_markdown_language = include_markdown_language)
    write_up_module_server("write_up", i18n, parent.session = session, auth = auth, reload_trigger,  session_folder_id = session_folder_id, include_markdown_language = include_markdown_language)
    upload_report_module_server("upload_report", i18n, auth = auth, base_group_files_url = base_group_files_url, final_reports_folder_id = final_reports_folder_id, parent.session = session)
    simulated_experiment_description_module_server("simulated_experiment_description", i18n, parent.session = session,  include_markdown_language = include_markdown_language)
    simulated_experiment_background_module_server("simulated_experiment_background", i18n, parent.session = session, include_markdown_language = include_markdown_language)
    simulated_experiment_hypothesis_module_server("simulated_experiment_hypothesis", i18n, parent.session = session)
    simulated_experiment_protocol_module_server("simulated_experiment_protocol", i18n, parent.session = session, include_markdown_language = include_markdown_language)
    simulated_experiment_measurements_module_server("simulated_experiment_measurements", i18n, parent.session = session, include_markdown_language = include_markdown_language)
    simulated_experiment_raw_data_module_server("simulated_experiment_raw_data", i18n, caf_data_read = caf_data_read, parent.session = session)
    simulated_experiment_analysis_module_server("simulated_experiment_analysis", i18n, caf_data_read = caf_data_read, parent.session = session, include_markdown_language = include_markdown_language)
    simulated_experiment_writing_up_module_server("simulated_experiment_writing_up", i18n, parent.session = session, include_markdown_language = include_markdown_language)
    feedback_module_server("feedback", i18n, feedback_data, parent.session = session)
