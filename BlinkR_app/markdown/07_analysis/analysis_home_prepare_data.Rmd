...
- **`group_by(id, stress_status)`**: This organises the data into groups based on the columns `id` and `stress_status`. It’s like putting data into labeled boxes so we can work on each group separately.
