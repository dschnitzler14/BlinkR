...
AI often generates false or misleading details, including made-up facts, sources, or quotes, making it unreliable for research-based writing.

#### 2. Lack of Critical Thinking
AI does not analyze or interpret information; it simply predicts words based on patterns, leading to shallow arguments without real insight or reasoning.
...
AI struggles with complex reasoning, logical argumentation, and synthesizing diverse viewpoints, resulting in weak or contradictory claims.
